Absolutely, Aditya! Here's your **Top 100 JavaScript Interview Questions** list—perfect for someone with **3–5 years of experience**. This covers everything from **basics to advanced** JavaScript, including ES6+, closures, async/await, OOP, DOM manipulation, event loop, functional programming, and more.

---

## ✅ Top 100 JavaScript Interview Questions
**(For 3–5 Years Experienced Developers)**
...
Great interview question! Understanding the difference between `var`, `let`, and `const` is essential in JavaScript, especially since ES6 (ECMAScript 2015) introduced `let` and `const` as improvements over the older `var`.
...
Let me know if you'd like to practice sample questions or scenarios involving `let`, `const`, and `var`!

---

## 3. What are JavaScript hoisting and temporal dead zones?

Excellent question — **hoisting** and the **temporal dead zone (TDZ)** are key JavaScript concepts that often come up in interviews.
...
Let me know if you’d like a practice quiz or want to see real-world bugs caused by hoisting and TDZ!

---

## 4. Explain the concept of scope in JavaScript.

Great question! **Scope** is a fundamental concept in JavaScript and often appears in both beginner and advanced interview questions.
...
Would you like to explore **closures**, which are built on lexical scope, or do a quick quiz to test your scope knowledge?

---

## 5. What is the difference between `==` and `===`?

Great question! This is one of the most **commonly asked JavaScript interview topics**, and understanding it well shows a solid grasp of JavaScript type coercion and comparison behavior.
...
Let me know if you'd like to try a few quiz questions or code snippets to practice spotting the difference!

---

## 6. What are truthy and falsy values?

Excellent! The concept of **truthy** and **falsy** values in JavaScript is **fundamental** when working with conditionals (`if`, `while`, ternary `? :`, etc.) — and it's a **very common interview topic**.
...
Would you like to practice identifying truthy/falsy behavior in example code snippets?

---

## 7. What is type coercion?

Great question! **Type coercion** is a key concept in JavaScript that often appears in interviews because it’s the root of many unexpected behaviors in code.
...
Would you like a cheat sheet of common coercion examples or a mini quiz to test your understanding?

---

## 8. What is NaN? How can you check if a value is NaN?

Great question! **NaN** (Not-a-Number) is a special value in JavaScript that often causes confusion — and it’s a **frequent interview topic**.
...
Let me know if you'd like a quick code challenge to practice identifying `NaN` in tricky expressions!

---

## 9. How does `typeof` work?

Great question! The `typeof` operator is a **fundamental tool** in JavaScript used to check the **type of a value**. It's simple, but there are some **important edge cases** interviewers love to ask about.
...
Would you like a quick quiz or practice problems to test your understanding of `typeof` behavior in tricky cases?

---

## 10. What is the difference between `null` and `undefined`?

Great question! Understanding the difference between `null` and `undefined` is essential in JavaScript and often comes up in interviews because it reveals your grasp of JavaScript’s type system and variable initialization.
...
Want me to prepare some practice questions to check your understanding of these concepts?

---

## 11. What is the use of `typeof null` being an object?

Great question! The fact that `typeof null` returns `"object"` is one of those quirky JavaScript oddities that often surprises beginners and even experienced developers.
...
Want me to help you with some tricky questions around type checking and null handling?

---

## 12. What are primitive and reference types?

Great topic! Understanding **primitive** vs **reference** types is fundamental in JavaScript and often comes up in interviews to test your grasp on how data is stored, copied, and compared.
...
Want me to give you some practice problems to spot differences between primitives and references?

---

## 13. What is pass-by-value and pass-by-reference in JS?

Awesome question! Understanding **pass-by-value** vs **pass-by-reference** is crucial in JavaScript, especially because it impacts how function arguments behave and how data changes propagate.
...
Would you like me to create some tricky function examples to practice this?

---

## 14. What is the difference between `Object.freeze()` and `Object.seal()`?

Great question! Both `Object.freeze()` and `Object.seal()` are methods in JavaScript used to control how objects can be modified, but they differ in **how strictly they restrict changes**.
...
Want me to prepare some code examples to test your understanding with `freeze` and `seal`?

---

## 15. What are spread and rest operators?

Great question! The **spread** and **rest** operators in JavaScript look identical (both use `...`), but they serve **different purposes** depending on the context. Understanding them is crucial for writing clean and flexible code.
...
Want me to generate a few tricky examples or quiz questions on spread/rest?
...
Great question! The concept of **first-class functions** is fundamental to JavaScript's power and flexibility.
...
Want me to help you explore how this leads to concepts like **closures** or **higher-order functions**?

---

## 17. What is a callback function?

Great! Let’s dive into **callback functions**, a core concept in JavaScript, especially in asynchronous programming.
...
Want some exercises or examples showing callback hell and how to avoid it?

---

## 18. What are arrow functions and how are they different?

Awesome question! **Arrow functions** are a concise syntax for writing functions in JavaScript, introduced in ES6 (ECMAScript 2015). They come with some important differences compared to regular function expressions.
...
Want me to generate some tricky examples on how `this` behaves differently in arrow vs regular functions?

---

## 19. What is a closure? Give a real-world example.

Great topic! **Closures** are one of the most powerful and sometimes tricky concepts in JavaScript. Let’s break it down clearly.
...
Want me to create some tricky closure problems or illustrate common closure pitfalls?

---

## 20. How does lexical scoping work?

Great question! **Lexical scoping** is a fundamental concept that underpins how variable lookup works in JavaScript and many other programming languages.
...
Want me to help you visualize scope chains or closures with diagrams?

---

## 21. What is the purpose of an IIFE (Immediately Invoked Function Expression)?

Great question! **IIFE** stands for **Immediately Invoked Function Expression**. It’s a pattern in JavaScript used to **run a function as soon as it’s defined**.
...
Want me to generate examples of IIFE with parameters or async IIFE?

---

## 22. What is currying in JavaScript?

Great topic! **Currying** is a powerful functional programming technique often used in JavaScript.
...
Want some examples of auto-currying utility functions or practical use cases?

---

## 23. What is function composition?

Great question! **Function composition** is a fundamental concept in functional programming and is widely used in JavaScript to create powerful, reusable, and clean code.
...
Want me to help you write a pipe function or show composition with asynchronous functions?

---

## 24. What is memoization?

Great question! **Memoization** is a powerful optimization technique often used in JavaScript to improve performance by caching results of expensive function calls.
...
Want me to help you write a generic memoization utility function?

---

## 25. What is the difference between a pure function and impure function?

Great question! Understanding **pure** vs **impure** functions is key in functional programming and writing predictable code.
...
Want me to show examples of converting impure functions into pure ones?

---

## 26. What is `this` keyword in JS?

Great question! The `this` keyword in JavaScript is a fundamental—but often confusing—concept. Let’s break it down clearly.
...
Want me to show tricky examples or common pitfalls with `this`?

---

## 27. How does `this` behave in arrow functions?

Awesome follow-up! The behavior of `this` in **arrow functions** is one of their defining features and a key difference from regular functions.
...
Want me to show examples comparing `this` in arrow vs regular functions in event handlers or classes?

---

## 28. What is the difference between call, apply, and bind?

Great question! `call`, `apply`, and `bind` are three JavaScript methods used to explicitly set the value of `this` inside a function. They’re similar but have key differences.
...
Want me to show advanced examples or common pitfalls with these methods?

---

## 29. What is function debouncing and throttling?

Great question! **Debouncing** and **throttling** are two popular techniques to control how often a function gets executed, especially in scenarios like user input, scrolling, or resizing where events can fire very frequently.
...
Want me to help you with code for combining debounce and throttle or real-world examples?

---

## 30. What is recursion and how is it used in JS?

Great question! Let’s dive into **recursion** and how it’s used in JavaScript.
...
Want me to show you how to convert recursion to iteration or explain tail recursion?
...
Great question! Objects are a core part of JavaScript and understanding them is essential.
...
Want me to explain prototypes or how object inheritance works next?

---

## 32. What is the prototype chain?

Great topic! The **prototype chain** is a fundamental concept behind JavaScript’s inheritance and object behavior.
...
Want me to explain how to create inheritance using prototypes or ES6 classes next?

---

## 33. What is prototypal inheritance?

Awesome, prototypal inheritance is key to understanding JavaScript’s object model!
...
Want examples of how to implement inheritance without classes, or explain prototype delegation more?

---

## 34. How is inheritance implemented in ES6?

Great question! ES6 introduced the `class` syntax, which provides a clearer, more concise way to implement inheritance in JavaScript, while under the hood it’s still using prototypal inheritance.
...
Want me to explain how inheritance worked before ES6 or show how to manually set prototypes?

---

## 35. What is `Object.create()`?

Great question! `Object.create()` is a very useful and important method in JavaScript, especially when dealing with prototypal inheritance.
...
Want me to show how `Object.create()` compares with constructors or classes?

---

## 36. What are getters and setters in JS?

Great question! **Getters and setters** are special methods in JavaScript that allow you to **control access** to an object’s properties, enabling you to run code when properties are read or assigned.
...
Want me to show you how getters and setters work with classes?

---

## 37. What are object destructuring and nested destructuring?

Great question! **Object destructuring** is a powerful and concise syntax in JavaScript that allows you to extract properties from objects into variables easily. **Nested destructuring** extends this idea to extract values from nested objects.
...
Want me to show you array destructuring too?

---

## 38. What is the difference between `in` and `hasOwnProperty()`?

Great question! Both `in` and `hasOwnProperty()` are used to check if an object contains a certain property, but they work differently and serve different purposes.
...
Want me to compare factory functions with constructor functions and classes?

---

## 40. What is the difference between a shallow and deep copy?

Great question! Understanding **shallow vs deep copy** is crucial when working with objects and arrays in JavaScript.
...
Want me to show you how to implement a deep clone function manually?

---

## 41. How do you clone an object in JavaScript?

Great question! Cloning objects in JavaScript can be done in multiple ways depending on whether you want a **shallow** or **deep** copy. Here’s a detailed explanation with examples.
...
Want me to help you write a deep clone function that handles Dates and other types?

---

## 42. What is the use of `Object.assign()`?

Great question! `Object.assign()` is a very handy method in JavaScript used for **copying properties** from one or more source objects to a target object.
...
Want me to compare `Object.assign()` with the spread operator `{ ...obj }`?

---

## 43. How can you iterate over object properties?

Great question! In JavaScript, there are several ways to **iterate over the properties of an object**. Here’s a detailed explanation with examples:
...
Want me to show examples of iterating with `Map` or `Set` collections too?

---

## 44. How do you merge two objects in JavaScript?

Great question! Merging two (or more) objects in JavaScript is a common task and can be done in several ways. Here’s a detailed explanation with examples:
...
Want me to show a deep merge example using Lodash or custom code?

---

## 45. What are Symbol and Symbol.iterator?

Great question! Both `Symbol` and `Symbol.iterator` are important concepts in modern JavaScript (ES6+). Let me explain them in detail:
...
Want me to show examples of other well-known symbols or how Symbols avoid property name conflicts?
...
Great question! `map()`, `filter()`, and `reduce()` are some of the most powerful and commonly used **array methods** in JavaScript. They help you transform, select, or accumulate array data in a clean, functional style.
...
Want me to show how to chain these methods together for complex array processing?

---

## 47. How does `reduce()` work internally?

Great question! Understanding how `reduce()` works internally helps grasp its power and flexibility.
...
Want me to show some practical use cases or tricky `reduce()` examples?

---

## 48. What is the difference between `forEach()` and `map()`?

Great question! Both `forEach()` and `map()` are used to iterate over arrays in JavaScript, but they have important differences in behavior and use cases.
...
Want me to show examples of chaining `map()` with other methods?

---

## 49. How do you remove duplicates from an array?

Great question! Removing duplicates from an array is a very common task in JavaScript, and there are several efficient ways to do it. Here are some popular methods with explanations and examples:
...
Want me to show how to remove duplicates from an array of objects based on a property?

---

## 50. How do you flatten an array?

Great question! Flattening an array means converting a nested array (an array with arrays inside it) into a single-level array.
...
Want me to explain how to flatten arrays without using built-in methods?

---

## 51. How do you reverse a string in JavaScript?

Great question! Reversing a string in JavaScript is a common task and can be done efficiently using built-in methods. Here's how it works step-by-step:
...
Want me to show you how to reverse words in a sentence, too?

---

## 52. How do you check if a string is a palindrome?

Great question! Checking if a string is a **palindrome** means verifying whether it reads the same forward and backward.
...
Want me to help with checking palindrome using recursion or other advanced techniques?

---

## 53. How do you convert an array to a string?

Good one! Converting an array to a string in JavaScript is straightforward and there are a few ways to do it depending on how you want the output formatted.
...
Want me to show how to convert nested arrays or arrays of objects to strings?

---

## 54. What are `find()`, `findIndex()`, `some()`, and `every()`?

Great question! These are very useful **array iteration methods** in JavaScript that help you search and test elements based on conditions.
...
Want me to show you how to combine these methods with other array functions?

---

## 55. How do you sort an array of objects?

Great question! Sorting an array of objects in JavaScript is commonly done using the `.sort()` method, where you provide a **compare function** that tells how to order the objects based on one or more properties.
...
Want me to help with sorting arrays containing nested objects or dates?

---

## 56. What is the difference between `Array.from()` and `Array.of()`?

Great question! Both `Array.from()` and `Array.of()` are methods introduced in ES6 to create arrays, but they serve **different purposes** and behave differently.
...
Want me to explain common pitfalls with the `Array` constructor as well?

---

## 57. What is the difference between slice and splice?

Great question! Both `slice()` and `splice()` are array methods in JavaScript that deal with extracting or modifying parts of an array, but **they behave very differently**.
...
Want me to provide common pitfalls or tricky interview questions on these?

---

## 58. What are template literals?

Awesome question! Template literals are a powerful and flexible way to work with strings in JavaScript, introduced in **ES6**.
...
Want me to show how to safely escape backticks or use nested template literals?

---

## 59. How do you deep clone an array?

Great question! Deep cloning an array means creating a **new array** with **all nested objects or arrays also copied**, so changes in the clone **don’t affect** the original.
...
Want me to help you write a deep clone function for objects with circular references?

---

## 60. What is the use of `includes()` in arrays and strings?

Great question! The `.includes()` method is available both on **arrays** and **strings** in JavaScript, and it’s used to **check if a certain element or substring exists** within them.
...
Want me to explain event loop with diagrams or demo code?

---

## 62. Explain the call stack, callback queue, and microtask queue.

Excellent question! These three components—**Call Stack**, **Callback Queue**, and **Microtask Queue**—are key players in how JavaScript handles **asynchronous behavior** in its **single-threaded** environment.
...
Want me to visualize this with a diagram or animation-style timeline?
...
Would you like examples for `Promise.all()` or how Promises work under the hood?

---

## 64. What are the states of a Promise?

Great question! A **JavaScript Promise** represents an asynchronous operation that can be in one of **three distinct states**:
...
Would you like to see how `Promise.all()` or `async/await` interacts with these states?

---

## 65. How is `async/await` different from `.then()`?

Great question! Both `async/await` and `.then()` are used to handle **Promises** in JavaScript, but they differ in **syntax**, **readability**, and **error handling**.
...
Want me to break down how `await` works behind the scenes or convert your existing `.then()` code to `async/await`?

---

## 66. What is the difference between `Promise.all()`, `Promise.any()`, `Promise.race()`?

Excellent question! Understanding the differences between `Promise.all()`, `Promise.any()`, and `Promise.race()` is key for effective handling of **multiple asynchronous operations** in JavaScript.
...
Would you like an example using `Promise.allSettled()` or how to use these in real API calls (like multiple fetches)?
...
Would you like to see a full example converting callback hell to async/await?
...
Would you like a working fetch example using `async/await`?

---

## 69. How does error handling work with `try-catch` and async/await?

Great question! In JavaScript, when you're using `async/await` to work with Promises, you handle errors using a `try...catch` block — just like you would for synchronous code. This approach makes error handling much **cleaner** and more **readable** compared to `.then().catch()` chains.
...
Would you like me to show a comparison of `try...catch` vs `.then().catch()` side-by-side?

---

## 70. What is the difference between synchronous and asynchronous code?

Great question! Understanding the difference between **synchronous** and **asynchronous** code is fundamental in JavaScript — especially because JavaScript is **single-threaded**, meaning it executes one command at a time.
...
Would you like a sample project that shows DOM manipulation in action (like a to-do list)?

---

## 72. How do you select elements in the DOM?

Great! Selecting elements in the DOM is one of the most common tasks in JavaScript for manipulating web pages. There are several methods to **select elements**, each useful in different situations.
...
Want me to show how to select elements and manipulate their content or styles next?

---

## 73. How do you add/remove classes to DOM elements?

Great! Adding and removing classes is a very common way to manipulate the appearance and behavior of DOM elements, especially when using CSS.
...
Want to see an example combining class manipulation with event listeners?

---

## 74. What is event bubbling and event capturing?

Great topic! Understanding **event bubbling** and **event capturing** is key to mastering how events flow through the DOM in JavaScript.
...
Want me to show how event delegation uses bubbling to handle events efficiently?

---

## 75. How do you stop event propagation?

Great follow-up! Stopping event propagation is crucial when you want to control how events flow through the DOM.
...
Want me to show an example where preventing propagation helps fix a UI bug?

---

## 76. What is `event.target` vs `event.currentTarget`?

Great question! Understanding the difference between `event.target` and `event.currentTarget` is very important when working with DOM events, especially with event delegation.
...
Want a demo showing event delegation using these properties?

---

## 77. What is event delegation?

Awesome! **Event delegation** is a powerful technique in JavaScript for efficiently handling events on multiple elements, especially dynamic or large lists of elements.
...
Want me to show how to delegate different events or how to handle delegated events with nested elements?

---

## 78. How do you handle form validation in JavaScript?

Great question! Handling **form validation** in JavaScript is a fundamental skill for creating interactive and user-friendly web applications.
...
Want me to show an example with live validation as the user types?

---

## 79. What is `localStorage`, `sessionStorage`, and `cookies`?

Great question! `localStorage`, `sessionStorage`, and cookies are all ways to store data on the client side in a web browser, but they have important differences in terms of scope, lifetime, size, and use cases.
...
Want me to show you examples on how to securely store and retrieve data using these?

---

## 80. How do you manipulate the DOM using JavaScript?

Great question! Manipulating the **DOM (Document Object Model)** with JavaScript is how you dynamically change the structure, content, and style of a webpage after it loads.
...
Want me to show how `let` and `const` behave inside loops or functions?

---

## 82. What is the use of arrow functions?

Great question! **Arrow functions** (`=>`) were introduced in ES6 to provide a shorter syntax for writing functions and to change how `this` behaves inside functions.
...
Want me to show you examples comparing arrow functions with traditional functions regarding `this`?

---

## 83. What is object and array destructuring?

Great question! **Destructuring** in JavaScript is a convenient way to extract values from objects or arrays into distinct variables using a concise syntax. It makes your code cleaner and easier to read.
...
Want me to give you a real-world example using destructuring in a React component or function?

---

## 84. What is the spread operator?

Awesome question! The **spread operator** in JavaScript is a powerful syntax represented by three dots: `...`. It allows you to **expand** iterable elements (like arrays or strings) or object properties into individual elements or key-value pairs.
...
Want me to show a code snippet demonstrating the difference between spread and rest?

---

## 85. What are template literals?

Great question! **Template literals** are a feature introduced in ES6 that make working with strings much easier and more readable compared to traditional string concatenation.
...
Want me to show examples comparing traditional concatenation vs template literals?

---

## 86. What are default parameters?

Great question! **Default parameters** were introduced in ES6 to make function parameter handling more concise and clear.
...
Want me to show you a code example demonstrating default parameters with various argument types?

---

## 87. What are rest parameters?

Great! Let’s dive into **rest parameters** — they’re a very handy feature introduced in ES6.
...
Want me to show you how rest parameters can replace `arguments` in a function?

---

## 88. What are modules in JavaScript (import/export)?

Great topic! **Modules** in JavaScript are a way to organize and reuse code by splitting it into separate files, each with its own scope. ES6 introduced a standardized module system with `import` and `export` keywords.
...
Want me to provide examples comparing old script loading vs modern ES6 modules?

---

## 89. What is optional chaining `?.`?

Great question! The **optional chaining operator (`?.`)** is a very useful feature introduced in ES2020 that helps you **safely access deeply nested object properties** without worrying about runtime errors when a property doesn’t exist.
...
Want me to provide some examples where optional chaining prevents errors in real-world API data handling?

---

## 90. What is nullish coalescing `??`?

Awesome! **Nullish coalescing (`??`)** is a useful operator introduced in ES2020 that works great alongside optional chaining. Let me explain it in detail.
...
Want me to explain microtasks vs macrotasks too?

---

## 92. What is the difference between deep copy and shallow copy?

Great question! Understanding **deep copy** vs **shallow copy** is important for working with objects and arrays in JavaScript, especially when dealing with mutations and state management.
...
Want me to show how to implement a deep copy function manually?

---

## 93. How does garbage collection work in JavaScript?

Great topic! Understanding **garbage collection** in JavaScript is important to know how memory management happens under the hood.
...
Would you like me to explain common memory leak patterns in JavaScript too?

---

## 94. What is the temporal dead zone?

Great question! The **Temporal Dead Zone (TDZ)** is a key concept related to `let` and `const` variables in JavaScript, important for interview prep.
...
Want a few tricky code snippets to test your understanding of TDZ?

---

## 95. What are JavaScript engines (V8, SpiderMonkey)?

Great question! Understanding **JavaScript engines** is helpful for grasping how JS code runs behind the scenes, which can impress interviewers.
...
If you'd like, I can also explain how JIT compilation works inside these engines!

---

## 96. What is the difference between eval and new Function()?

Great question! Both `eval` and `new Function()` allow you to execute JavaScript code dynamically as strings, but they behave quite differently and have different use cases and security implications.
...
Want me to show how to safely evaluate expressions without `eval`?

---

## 97. What is tail call optimization?

Great question! **Tail Call Optimization (TCO)** is an important concept in functional programming and JavaScript performance, especially relevant in recursive function calls.
...
Want me to show how to convert a normal recursion into tail recursion?

---

## 98. What is Service Worker and how does it work in JavaScript?

Awesome question! **Service Workers** are a powerful feature in modern web development, especially for building **Progressive Web Apps (PWAs)** with offline capabilities, background sync, and more.
...
Want me to explain how caching strategies work with service workers next?

---

## 99. What are WeakMap and WeakSet?

Great question! **WeakMap** and **WeakSet** are special built-in JavaScript collections designed to help with **memory management** and **garbage collection** by holding "weak" references to objects.
...
Want me to provide a practical example where WeakMap helps avoid memory leaks?

---

## 100. What are some common JavaScript memory leaks and how to avoid them?

Great topic! Memory leaks in JavaScript can cause your web app to consume more and more memory over time, leading to poor performance or even crashing. Understanding common causes and how to avoid them is crucial, especially for interview prep.
...
If you want, I can also share some Chrome DevTools tips to detect memory leaks!
...
- ✅ All questions with **answers + examples**
- ✅ **JavaScript Cheatsheet PDF**
- ✅ **JavaScript practice coding problems**
- ✅ **Topic-wise roadmap** for mastering JavaScript

Let me know how you'd like to proceed, and I’ll build it for you step by step!