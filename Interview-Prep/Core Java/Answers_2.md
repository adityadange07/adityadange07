Here you go, Aditya — a **comprehensive list of the Top 100 Core Java Interview Questions**, ideal for someone with **3–5 years of hands-on experience**. These questions cover everything from **OOPs, Collections, Multithreading, Exception Handling, Memory Management, Java 8 features**, and more.
